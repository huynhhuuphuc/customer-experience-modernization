...
export const routes: Routes = [
  {
    ...
    title: "CSM - Demo Terms",
  },
  { path: "", redirectTo: "/demo/terms", pathMatch: "full" }, // redirect to `first-component`
  {
    path: "demo/user-journey",
    component: UserJourneyComponent,
    title: "CSM - User Journeys",
  },
  {
    path: "demo/customer",
    component: CustomerGuideComponent,
    title: "CSM - Customer Guide",
  },
  {
    path: "customer/home",
    component: CustomerHomeComponent,
    title: "Cymbal Furniture - Home",
  },
  {
    path: "customer/home/add-to-cart",
    component: AddToCartDetailsComponent,
    title: "Cymbal Furniture - Shopping Cart",
  },
  {
    path: "content-creator/home",
    component: ContentCreatorHomeComponent,
    title: "Cymbal Furniture CMS - Home",
  },
  {
    path: "content-creator/add-product",
    component: ContentCreatorAddProductComponent,
    title: "Cymbal Furniture CMS - Add Product",
  },
  {
    path: "content-creator/add-service",
    component: ContentCreatorAddServiceComponent,
    title: "Cymbal Furniture CMS - Add Service",
  },
  {
    path: "content-creator/edit-product",
    component: ContentCreatorEditProductComponent,
    title: "Cymbal Furniture - Edit Product",
  },
  {
    path: "content-creator/edit-service",
    component: ContentCreatorEditServiceComponent,
    title: "Cymbal Furniture - Edit Service",
  },
  {
    path: "customer-experience-analyst/home",
    component: CustomerExperienceAnalystHomeComponent,
    title: "Cymbal Furniture - CX Management - Home",
  },
  {
    path: "customer-service-agent/home",
    component: CustomerServiceAgentHomeComponent,
    title: "Cymbal Furniture - Customer Service - Home",
  },
  {
    path: "contact-center-analyst/home",
    component: ContactCenterAnalystHomeComponent,
    title: "Cymbal Furniture - Contact Center - Home",
  },
  {
    path: "field-service-agent/home",
    component: FieldServiceAgentHomeComponent,
    title: "Cymbal Furniture - Field Service - Home",
  },
  {
    path: "field-service-agent/job",
    component: FieldServiceAgentJobComponent,
    title: "Cymbal Furniture - Field Service - Job",
  },
  {
    path: "fulfillment-agent/home",
    component: FulfillmentAgentHomeComponent,
    title: "Cymbal Furniture - Fulfillment Service - Home",
  },
  {
    path: "return-service/guide",
    component: GuideComponent,
    title: "Cymbal Furniture - Return Agent Service - Guide",
  },
  {
    path: "return-service/home",
    component: ReturnServiceComponent,
    title: "Cymbal Furniture - Return Agent Service - Home",
  },
  {
    path: "return-service/order",
    component: ReturnOrderComponent,
    title: "Cymbal Furniture - Return Agent Service - Order",
  },
  {
    path: "return-service/refund-item/:is_valid",
    component: RefundItemComponent,
    title: "Cymbal Furniture - Return Agent Service - Home",
  },
  {
    path: "return-service/agent-view/home",
